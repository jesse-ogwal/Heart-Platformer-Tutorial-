...
func handle_wall_jump():
	...
	var wall_normal = get_wall_normal() #normal is a vector that points away from wall
...
func _on_hazard_detector_area_entered(_area): #icon indicates func is connected to a signal 
